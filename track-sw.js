const CACHE_NAME = 'talagty-customer-v3';
const LOCAL_ASSETS = ['./track.html', './track.css?v=manual-whatsapp-1', './track.js?v=manual-whatsapp-1', './style.css?v=store-mobile-v2', './api-config.js'];
