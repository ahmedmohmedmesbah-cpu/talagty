    ...
    function generatePdfReceipt(orderData) {
        loadJsPDF(({ jsPDF }) => {
            ...
            orderData.items.forEach(item => {
                const product = PRODUCTS_MAP[item.id];
                if (product) { // Ensure product exists before trying to access its properties
